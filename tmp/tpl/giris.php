...
<body  > 
  ...
  <table id="lb">
    <tbody><tr><td style="white-space: nowrap;">kullanıcı adı</td>

    <td style="white-space: nowrap; text-align: right;">(<a target="sportakisim" href="?aksiyon=kayit">yeni kayıt</a>)
    </td>
    </tr>
    <tr><td colspan="2">
      <input name="gnick" id="n" tabindex="1" class="lin" maxlength="40" size="20" type="text" /></td></tr>
    <tr><td>şifre</td><td style="white-space: nowrap;" align="right">(<a href="#" onclick="od('?islem=kayit')">şifremi unuttum</a>)</td></tr>
    ...
    <tr><td colspan="2" style="text-align: center;">
      <input tabindex="6" id="b" class="but" value="Giriş Yap!" style="float: right;" type="submit" name="giris"/>
    </td></tr>
  </tbody></table>
  </form>
</div></div>
