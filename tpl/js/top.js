...

{
...

        {
          ...
          write('<div align=right><table id=m'+i+' style="visibility:hidden"><tr><td class=ei><a name="cid'+i+'"></a><a href="#cid" onclick="copyid('+i+','+f+');">#'+i+'</a></td>');
                  ...
                  a("javascript:od('sozluk.php?process=arti&id="+i+"')","miss gibi","$ukela!");

                  a("javascript:od('sozluk.php?process=enteresan&id="+i+"')","enteresan","enteresan");

                  a("javascript:od('sozluk.php?process=eksi&id="+i+"');","shit!","oeehh");

                  document.write('<td>&nbsp;</td>');

                  a("javascript:location.href='sozluk.php?process=privmsg&islem=yenimsj&gkime="+an+"&gkonu="+i+" nolu entry';","/msj","mesaj at");

                  a("sozluk.php?process=ben&kim="+an+"","?","yazar hakkinda");

                  a("javascript:od('sozluk.php?process=sikayetgiris&id="+i+"','700','400')","!","sikayet et");
...

{
...

        {
          ...
          write('<div align=right><table id=m'+i+' style="visibility:hidden"><tr><td class=ei><a name="cid'+i+'"></a><a href="#cid" onclick="copyid('+i+','+f+');">#'+i+'</a></td>');
            ...
            a("javascript:location.href='sozluk.php?process=eduzenle&id="+i+"&sr="+sr+"';","/düzenle","entry düzenle");

			a("javascript:location.href='sozluk.php?process=etasi&id="+i+"&sr="+sr+"';","/tasi","bu entry yi uzak diyarlara götür");
...

{
...

        {
          ...
          write('<div align=right><table id=m'+i+' style="visibility:hidden"><tr><td class=ei><a name="cid'+i+'"></a><a href="#cid" onclick="copyid('+i+','+f+');">#'+i+'</a></td>');
            ...
            a("javascript:location.href='sozluk.php?process=eduzenle&id="+i+"&sr="+sr+"';","/edit","entry düzenle");
...

{
	...
	var u = "http://www.anarsisozluk.com/"+id+".id";
...

{
      ...
      '<option value="http://www.allmusic.com/cg/amg.dll?p=amg&opt1=3&sql=">þarký</option>'+
